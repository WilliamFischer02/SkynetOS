...
const BLURB: Record<NodeKind, string> = {
  ...
  'agent.audit': 'A drive auditor. Claude Code at a drive root that surveys, proposes and moves to quarantine with your approval, and never deletes. Hops to the other drives you grant it.',
  ...
  'agent.prompt': 'A quick-chat box on the board. Type, attach files or images, press Enter: the JARVIS conversation opens and it is sent there.',
  'agent.prompt-to-node': 'Describe a node, press Enter: a fresh JARVIS Prime terminal opens with your words as a brief to build it on this board, bound to real paths. Tabbed PROMPT → NODE so it is never mistaken for a quick chat.',
  ...
  'store.explorer': 'A retro file browser over one real folder. Double-click to walk it, open files, drag them out, and choose the folder it rests on.',
...
const LABEL: Record<NodeKind, string> = {
  ...
  'agent.audit': 'DRIVE AUDITOR',
  'agent.chat': 'CONVERSATION',
  'agent.jarvis': 'JARVIS HEAD',
  'agent.prompt': 'QUICK CHAT PROMPT',
  'agent.prompt-to-node': 'PROMPT → NODE',
  'drive.room': 'ROOM DRIVE',
  'store.repo': 'REPOSITORY',
  'store.folder': 'FOLDER',
  'store.explorer': 'FILE EXPLORER',
